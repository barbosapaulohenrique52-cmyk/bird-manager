  ...
  const proximasAcoes = ovos.flatMap(({ egg, ninho }) => {
    ...
    if (
      ...
      acoes.push({
        ...
        detalhe: `Ninho ${ninho.name || ninho.id}`,
        tipo: 'fertilidade'
      });
    }
  ...
  return (
    <section className="w-full space-y-5 pb-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
        <button
          type="button"
          onClick={() => window.dispatchEvent(new CustomEvent('gouldpro-navigate', { detail: 'aves' }))}
        ...
        <button
          type="button"
          onClick={() => window.dispatchEvent(new CustomEvent('gouldpro-navigate', { detail: 'casais' }))}
          className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 text-left hover:shadow-md transition-all"
        >
        ...
        <button
          type="button"
          onClick={() => window.dispatchEvent(new CustomEvent('gouldpro-navigate', { detail: 'ninhos' }))}
          className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 text-left hover:shadow-md transition-all"
        >
