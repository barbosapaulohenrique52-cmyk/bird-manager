...
export function useDatabase() {
   ...
   *
   * Essa propriedade será formalizada na interface Egg do App.tsx
   * no próximo passo.
   */
  const registrarSaidaDoNinho = useCallback(
    (
       ...
       *
       * Usamos a propriedade diretamente no objeto para manter
       * compatibilidade enquanto a interface Egg do App.tsx
       * ainda não recebeu o novo campo.
       */
