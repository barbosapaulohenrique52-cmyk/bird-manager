                        ...
                        {macho?.photo ? (
                          <button
                            ...
                            aria-label={`Ampliar foto de ${
                              macho.name || macho.ring || 'macho'
                            }`}
                          >
                            <img
                              src={macho.photo}
                              className="w-16 h-16 rounded-xl object-cover cursor-zoom-in hover:scale-105 transition-transform"
                              alt={macho.name}
                            />
                          </button>
                        ) : (
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {femea?.photo ? (
                          <button
                            type="button"
                            onClick={(event) =>
                              abrirFoto(event, femea.photo!)
                            }
                            className="flex-shrink-0 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-400"
                            title="Clique para ampliar a foto"
                            aria-label={`Ampliar foto de ${
                              femea.name || femea.ring || 'fêmea'
                            }`}
                          >
                            <img
                              src={femea.photo}
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="text-xs font-black text-pink-600 mb-0.5">
                            FÊMEA
                          </div>
