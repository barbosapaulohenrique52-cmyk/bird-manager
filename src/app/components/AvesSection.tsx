...
import type { Ave, ModalType, Config, Ninho, DashboardFiltro } from '../App';
...
export function AvesSection({
  ...
  useEffect(() => {
    if (dashboardFiltro?.tipo !== 'aves') return;

    if (dashboardFiltro.status) {
      setFiltroStatus(dashboardFiltro.status);
    }
